...
const systemApi = {
  ...
  login_sendpwd_phone: '{doAdmin}public/sendpwdtel.do', // 手机找密码
  login_sendpwd_mail: '{doAdmin}public/sendpwdemail.do', // 邮箱找回密码
...
export default core({
  ...
  keys: {
    ...
    MESSAGE_ORDER:'{name}order-name',//订单选择信息
    SUP_NAME:'{name}sup-name',//订单选择信息
  },
