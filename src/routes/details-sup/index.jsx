    ...
    return ( <div>
      <ul className={styles.textbody}>
        ...
        <li>
          ...
          <span className={styles.value}>{this.props.editsup.details.housename}</span>
        </li>
        <li>
        ...
        <li>
          ...
          <span className={styles.value}>{this.props.editsup.details.checkamount}{this.props.editsup.details.unitname}</span>
        </li>
        <li>
