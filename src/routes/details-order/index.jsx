...
import { ListView, List, Stepper } from 'antd-mobile';
    ...
    return ( <div>
      <ul className={styles.textbody}>
        ...
        <li>
          ...
          <span className={styles.value}>{this.props.editbill.details.housename}</span>
        </li>
        <li>
        ...
        <li>
          ...
          <span className={styles.value}>{this.props.editbill.details.checkamount}{this.props.editbill.details.unitname}</span>
        </li>
        <li>
        ...
        <li>
          ...
          <span className={styles.value}>{this.props.editbill.title.orderoutmoney} 元</span>
        </li>
      </ul>
      <button style={{
        width: '100%',
